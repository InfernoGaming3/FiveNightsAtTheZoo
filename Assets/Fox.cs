...
public class Fox : MonoBehaviour
{
    ...
    public void UpdatePosition()
    {
        ...
        if (GameMaster.instance.camBackground.sprite.name.ToLower() == locations[curLocationIndex].ToLower())
        {
            ...
            if(GameMaster.instance.camBackground.sprite.name.ToLower() != "lefthallway" && GameMaster.instance.monitorUp) curLocationIndex--;
        ...
        else if (locations[curLocationIndex].ToLower() == "jumpscare")
        {
            ...
            if (!GameMaster.instance.audioSource.isPlaying) GameMaster.instance.audioSource.PlayOneShot(GameMaster.instance.foxJumpscare);
        }
    }
    ...
    {
        if(GameMaster.instance.camBackground.sprite.name.ToLower() != locations[curLocationIndex].ToLower()
            || locations[curLocationIndex] == "lefthallway")
        {
            curLocationIndex++;
